        ...
        <Container style={centerJustified}>
            ...
            <Grid container rowSpacing={3} spacing={5} columnSpacing={{ xs: 1, sm: 2, md: 3 }}>
                <Grid item sm={6}>
                    <Container maxWidth="sm">
                        <Typography variant="h4" gutterBottom component="div">
                            <Link href="https://github.com/Pustalorc/BaseClustering" underline="hover">Base Clustering</Link>
                        </Typography>
                ...
                <Grid item xs={6}>
                    <Container maxWidth="sm">
                        <Typography variant="h4" gutterBottom component="div">
                            <Link href="https://github.com/Pustalorc/FrequencyCache" underline="hover">Frequency Access Cache</Link>
                        </Typography>
                        <Typography variant="body2" gutterBottom>
                ...
                <Grid item xs={12}>
                    <Container maxWidth="sm">
                        <Typography variant="h4" gutterBottom component="div">
                            <Link href="https://github.com/Pustalorc/MySqlConnectorWrappers" underline="hover">MySql Connector Wrappers</Link>
                        </Typography>
                        <Typography variant="body2" gutterBottom>
                            A set of published NuGet libraries for both MySql.Data and MySqlConnector that implements the <Link href="https://github.com/Pustalorc/FrequencyCache" underline="hover">Frequency Access Cache</Link> project for built in query + query result caching.
                        </Typography>
                        <br/>
                        <Typography variant="body2" gutterBottom>
                ...
                <Grid item xs={6}>
                    <Container maxWidth="sm">
                        <Typography variant="h4" gutterBottom component="div">
                            <Link href="https://github.com/openmod/openmod" underline="hover">OpenMod</Link>
                        </Typography>
                        <Typography variant="body2" gutterBottom>
                ...
                <Grid item xs={6}>
                    <Container maxWidth="sm">
                        <Typography variant="h4" gutterBottom component="div">
                            <Link href="https://pustalorc.github.io/UnturnedServerManager/" underline="hover">Unturned Server Manager</Link>
                        </Typography>
                        <Typography variant="body2" gutterBottom>
            ...
            <Grid container rowSpacing={1} columnSpacing={{ xs: 1, sm: 2, md: 3 }}>
                ...
                <Grid item xs={6}>
                    <Container maxWidth="sm">
                        ...
                        <Typography variant="body2" gutterBottom>
                            A web project developed with <Link href="https://koajs.com/" underline="hover">Koa</Link>.
                        </Typography>
                        <br />
                        <Typography variant="body2" gutterBottom>
                ...
                <Grid item xs={12}>
                    <Container maxWidth="sm">
                        ...
                        <Typography variant="body2" gutterBottom>
                            ...
                            Back-end was developed with <Link href="https://koajs.com/" underline="hover">Koa</Link>, whilst frontend was developed with <Link href="https://reactjs.org/" underline="hover">React</Link>.
                        </Typography>
                        <br />
                        <Typography variant="body2" gutterBottom>
                    ...
                    <Grid container rowSpacing={3} spacing={5} columnSpacing={{ xs: 1, sm: 2, md: 3 }}>
                        ...
                        <Grid item sm={4}>
                            <Typography variant="body1" align='right' color="inherit">
                                Created with <Link href="https://reactjs.org/" underline="hover">ReactJs</Link>, <Link href="https://www.gatsbyjs.com/" underline="hover">Gatsby</Link> & <Link href="https://mui.com/" underline="hover">MaterialUI</Link>
                            </Typography>
                        </Grid>
                    </Grid>
                </Toolbar>
